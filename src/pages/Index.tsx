      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-background/60 border-b border-border/50">
        <nav className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between" aria-label="Hauptnavigation">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href="https://opensmartfridge.de/docs"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <footer className="border-t border-border/40 py-8 pb-28 sm:pb-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://opensmartfridge.de/docs" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground/60 hover:text-foreground transition-colors">
              Dokumentation
            </a>
          </div>
        </div>
